...
util.redirectUrl = function(){
	...
	// if (curHost.indexOf("www") < 0 && curHost.indexOf("visitseoul.net") > -1) {
    //     if(curHost !== 'dev.visitseoul.net' && curHost !== 'qa.visitseoul.net' && curHost !== 'dev.thebreeze.co.kr') {
    //         location.href = location.protocol + "//www." + location.hostname + location.pathname + location.search + location.hash;
    //     }
	// }
